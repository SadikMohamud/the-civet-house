-- The Civet House: one-shot setup.
-- Combines the schema migration and the seed. Safe to run once on a fresh
-- project. Paste the whole file into the Supabase SQL editor and run it.
